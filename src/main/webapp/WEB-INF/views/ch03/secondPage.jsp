...
<hr>
<a href='SessionStatus_setComplete'>執行SessionStatus_setComplete()後，轉第三頁</a>&nbsp;&nbsp;&nbsp;&nbsp;
<a href='SessionInvalidate'>執行Session_invalidate()後，轉第三頁</a><br>
在Ch03Controller2類別內的控制器方法取得的Cat物件：${secondPageCat}
<hr>
<%
  out.println("----------------執行secondPage.jsp時，位於HttpSession中的屬性物件----------------<br>");
...
<hr>
<%
    out.println("----------------執行secondPage.jsp時，位於HttpServletRequest中的屬性物件----------------<br>");
%>
	<table border='1'>
	<tr><th>Key</th><th>Value</th></tr>
<%      
