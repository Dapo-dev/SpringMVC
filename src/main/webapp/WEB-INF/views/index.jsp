...
<ul >
  ...
  <li><a href="<c:out value='${pageContext.request.contextPath}' />/ch03/index" >三、Session</a> </li>
  <li><a href="<c:out value='${pageContext.request.contextPath}' />/ch04/index" >四、Session應用：購物車</a> </li>
